...
public class HUD extends Halja{
	...
	public void draw(Graphics g){
		...
		*/
		Rectangle rectHealth = new Rectangle((guiWidth / 2) - 100, guiHeight - 50, 200, 20);
		...
		g.fillRect(rectHealth.x + 1, rectHealth.y + 1, (int) ((rectHealth.width - 2) * pcntHealth), rectHealth.height - 1);
		...
		*/
		Rectangle rectArmour = new Rectangle((guiWidth / 2) - 100, guiHeight - 25, 200, 20);
		g.setColor(Color.BLACK);
		...
		g.fillRect(rectArmour.x + 1, rectArmour.y + 1, (int) ((rectArmour.width - 2) * pcntArmour), rectArmour.height - 1);
	}
